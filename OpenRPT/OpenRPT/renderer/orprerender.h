...
class ORPreRender {
  public:
    ORPreRender(QSqlDatabase = QSqlDatabase::database("Maya"));
    ORPreRender(const QDomDocument &, QSqlDatabase = QSqlDatabase::database("Maya"));
    ORPreRender(const QDomDocument &, const ParameterList &, QSqlDatabase = QSqlDatabase::database("Maya"));
    virtual ~ORPreRender();
